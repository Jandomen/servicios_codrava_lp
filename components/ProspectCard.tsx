...
export function ProspectCard({
    ...
    return (
        <motion.div
            ...
            className="group relative flex flex-col rounded-xl border border-zinc-800 bg-[#0B0B0E] p-5 shadow-lg transition-all hover:border-[#D4AF37]/50 hover:shadow-gold cursor-pointer"
        ...
        >
            ...
            {/* Actions */}
            <div className="mt-auto grid grid-cols-[1fr_auto_auto] gap-2" onClick={(e) => e.stopPropagation()}>
                <button
                    onClick={() => onViewDetails?.(prospect)}
                    className="rounded-lg bg-gradient-to-r from-[#D4AF37] to-[#B5952F] px-4 py-2 text-xs font-bold text-black shadow-[0_0_10px_rgba(212,175,55,0.2)] hover:shadow-[0_0_20px_rgba(212,175,55,0.4)] hover:brightness-110 active:scale-[0.98] transition-all"
                >
                    Ver Ficha Completa
                </button>
                {prospect.whatsapp && (
                    <a
                        ...
                        className="flex h-9 w-9 items-center justify-center rounded-lg border border-zinc-800 bg-zinc-900 text-green-500 transition-colors hover:border-green-500/50 hover:bg-green-500/10 hover:shadow-[0_0_10px_rgba(34,197,94,0.2)]"
                        title="WhatsApp"
                    >
                ...
                <a
                    ...
                    className="flex h-9 w-9 items-center justify-center rounded-lg border border-zinc-800 bg-zinc-900 text-[#D4AF37] transition-colors hover:border-[#D4AF37]/50 hover:bg-[#D4AF37]/10 hover:shadow-gold"
                    title="Llamar"
                >
                ...
                {prospect.email && (
                    <a
                        ...
                        className="flex h-9 w-9 items-center justify-center rounded-lg border border-zinc-800 bg-zinc-900 text-blue-400 transition-colors hover:border-blue-400/50 hover:bg-blue-400/10 hover:shadow-[0_0_10px_rgba(96,165,250,0.2)]"
                        title="Enviar Correo"
                    >
